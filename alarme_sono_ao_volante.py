...
MAR_THRESH = 0.50 # LIMIAR DO MAR. ACIMA DISSO = BOCEJO // POSSÍVEL NECESSIDADE DE AJUSTE
...
NEP_THRESH = 0.30 #imagine que é um sensor de altura, isso aqui é um limiar para ver a sobrancelha está mais levantada que o normal.
